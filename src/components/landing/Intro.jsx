  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-center px-6 md:px-10 lg:px-20 py-16 md:py-24 h-auto gap-12 lg:gap-20">
        ...
        {/* left */}
        <div className="w-full lg:w-1/2 h-auto flex items-center lg:items-start justify-center flex-col text-center lg:text-left" data-aos="fade-right">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-gwen-semibold w-full leading-snug text-[#2b3780]">
          ...
          <div className="flex justify-center lg:justify-start">
            <Button label="About Us" href="/about" b_radius="rounded-full" border={false} bg_color="#2b3780" hov_bg="white" hov_text="#2b3780" />
          </div>
        </div>

        {/* right images */}
        <div className="w-full lg:w-1/2 h-auto flex flex-row lg:flex-row items-center justify-center gap-6 lg:gap-8">
          <img
            src="IntroNew1.webp"
