...
const Contact = () => {
  const breadcrumbItems = [{ label: "Home", to: "/" }, { label: "Contact Us" }];
  ...
  const handleContactSubmitWeb3Froms = async (e) => {
    ...
    formData.append("access_key", "185de8f1-1c28-4d1e-a542-28c13cf4b558"); // Replace with Web3Forms access key if using any other email excepts info@skpandassociates.com
  ...
  const office_locations = [
    ...
    // noida
    {
      ...
      contacePerson: "CA Meenakshi Kumari",
      email: "skpa.cameenakshi@gmail.com",
      email2: "info@skpandassociates.com",
      phone: "+91 99685 85146",
      landline: "+91 120 408 9138",
      address: "C- 69, Sector-2, Noida, Uttar Pradesh- 201301",
      mapEmbed: (
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2477.373249038951!2d77.31241644296803!3d28.583727426874365!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce45ed6f7bf2d%3A0xafef075582efcd5e!2sSANJAY%20K%20PATHAK%20%26%20ASSOCIATES!5e0!3m2!1sen!2sin!4v1772255564153!5m2!1sen!2sin"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen=""
    ...
    // head office bihar
    {
      name: "H/O Darbhanga - Bihar",
      contacePerson: "CA Sanjay Kumar Pathak",
      email: "skpa.cameenakshi@gmail.com",
      email2: "info@skpandassociates.com",
      phone: "+91 99685 85146",
      landline: "+91 120 408 9138",
      ...
      address:
        "H/O Professor Shravan Kumar Mishra Retd. Principal West Of Dighi Pokhar Professor’s Colony Darbhanga- 846004",
      mapEmbed: (
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1790.6921633982558!2d85.90207821066146!3d26.15161007779663!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39edb91a510d23f3%3A0xeabdbc55df1b51c7!2sProfessor&#39;s%20Colony!5e0!3m2!1sen!2sin!4v1772255321684!5m2!1sen!2sin"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen=""
    ...
    // maharashtra
    {
      ...
      landline: "+91 120 408 9138",
      address:
        "GF - 22, Hans Bhawan 1, Bahadur Shah Zafar Marg New Delhi – 110002",
      mapEmbed: (
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1041.1782420316442!2d77.24107179250342!3d28.626998495617656!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd0024d67645%3A0x53166238b9f005f3!2sHans%20Bhawan%20Wing-1!5e0!3m2!1sen!2sin!4v1772255850350!5m2!1sen!2sin"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen=""
    ...
    <>
      <div className="min-h-screen w-full relative bg-gradient-to-br from-white via-blue-50 to-white">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(45deg, transparent, transparent 10px, #2b3780 10px, #2b3780 20px)",
            opacity: 0.03,
          }}
        />
        ...
        {/* Page heading */}
        <div
          className="text-center w-full pt-16 sm:pt-20 px-4 relative z-10"
          data-aos="fade-up"
        >
        ...
        {/* Main wrapper */}
        <div
          className="w-full flex justify-center items-center px-4 py-10 relative z-10"
          data-aos="fade-up"
          data-aos-delay="500"
        >
          <div className="w-full sm:w-[95%] lg:w-[85%] flex flex-col lg:flex-row gap-12 justify-between items-start h-fit bg-white rounded-2xl shadow-lg shadow-blue-200/30 border border-blue-100 px-6 sm:px-10 md:px-16 py-8 sm:py-12 mb-20 text-sm sm:text-base md:text-lg">
            ...
            <div className="w-full lg:w-1/2">
              ...
              >
                ...
                <div className="flex flex-col gap-3">
                  <span htmlFor="name" className="font-semibold text-gray-700">
                    Name :
                  </span>
                  <input
                    type="text"
                ...
                <div className="flex flex-col gap-3">
                  <span htmlFor="email" className="font-semibold text-gray-700">
                    Email :
                  </span>
                  <input
                    type="email"
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
              <h3 className="text-2xl sm:text-3xl text-[#2b3780]">
                Our Offices
              </h3>
              <div className="flex flex-wrap gap-2 sm:gap-3">
                {office_locations.map((branch) => (
                  <button
                    key={branch.name}
                    className={`px-4 sm:px-5 py-2.5 rounded-lg border-2 text-xs sm:text-sm md:text-base cursor-pointer font-medium transition-all duration-300 ${
              ...
              <div className="w-full flex flex-col gap-6 mt-4 p-6 bg-blue-50 rounded-xl border border-blue-200">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-lg font-semibold text-[#ff6b6b]">{selectedBranch.address}</p>
                  {selectedBranch.phone && (
                      <div className="flex flex-col gap-2">
                        ...
                        <a
                          ...
                          className="text-lg font-semibold text-[#ff6b6b] hover:underline"
                        >
                          {selectedBranch.phone} <br />
                          {/* {selectedBranch.landline} */}
                        </a>
                        <a
                          href={`tel:${selectedBranch.landline}`}
                          className="text-lg font-semibold text-[#ff6b6b] hover:underline"
                        >
                          {/* {selectedBranch.phone} <br /> */}
                          {selectedBranch.landline}
                  ...
                  {selectedBranch.email && (
                      <div className="flex flex-col gap-2">
                        ...
                        <a
                          href={`mailto:${selectedBranch.email2}`}
                          className="text-lg font-semibold text-[#ff6b6b] hover:underline"
                        >
                          {selectedBranch.email2}
                        </a>
                      </div>
                    )} 
                </div>
